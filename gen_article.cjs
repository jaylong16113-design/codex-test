...
const outPath = path.join('/home/ric_16113', '.hermes', 'codex-test', 'src', 'lib', 'content', 'en', 'seo-audit-automation-tools-solopreneur-2026.json');
...
console.log('Valid JSON. Content length:', readback.content.length, 'chars');
console.log('Word count:', readback.content.split(/\s+/).length);
