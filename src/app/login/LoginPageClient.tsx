  ...
  return (
    <form onSubmit={handleSubmit} className="mt-10 space-y-5">
      <label className="block">
        ...
        <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="请输入密码" className="w-full rounded-none border border-white/20 bg-[#0d0e0d] px-4 py-4 text-sm text-white outline-none placeholder:text-white/25 focus:border-[#d8ff00]" autoFocus />
      </label>
...
export default function LoginPageClient() {
  return (
    <main className="grid min-h-screen place-items-center bg-[#080908] p-5">
