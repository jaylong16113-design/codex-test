...
export const metadata: Metadata = {
  ...
  description: "AI e-commerce tools reviews, men's style guide, solo entrepreneur operations playbook, emotional short video creation — four content sites, one AI growth system. One person, one domain, infinite possibilities.",
  openGraph: {
    title: "AgentClaw — AI Growth Engine for Solo Entrepreneurs",
    description: "AI Tools · Style Guide · Solo OPS · Mood Videos",
