...
export async function generateMetadata({ params }: any): Promise<Metadata> {
  ...
  return {
    title: a?.title || "Emotional Short Video Guide",
...
const heroImages: Record<string, string> = {
  "emotion-short-video-basics": "/images/video-editing.jpg",
  "ai-video-script-tools": "/images/ai-tools.jpg",
  "clipchamp-capcut-emotional-editing": "/images/video-editing.jpg",
  "ai-voiceover-music-tools": "/images/ai-comparison.jpg",
  "viral-duan-emotional-video-case": "/images/ecommerce-data.jpg",
};
    ...
    <>
      ...
      <article className="max-w-3xl mx-auto article-content">
        <div className="flex items-center gap-2 text-xs text-gray-400 mb-4 px-4 pt-6">
          ...
          <span>/</span>
          <Link href="/en/mood" className="hover:text-gray-200">Mood Videos</Link>
          <span>/</span>
        ...
        <div className="px-4">
          ...
          <p className="text-sm text-gray-400 mb-6 border-l-2 border-pink-500/50 pl-3 italic">{article.excerpt}</p>
          ...
          <div className="prose-invert max-w-none">
            <ReactMarkdown
              ...
              components={{
                ...
                blockquote({ children }) { return <blockquote className="border-l-4 border-pink-500/50 bg-white/5 px-4 py-3 my-6 italic text-gray-300 text-sm rounded-r-lg">{children}</blockquote>; },
          ...
          <div className="flex flex-wrap gap-2 mt-8 pt-6 border-t border-gray-700">
            <span className="tag bg-pink-900/40 text-pink-300">Mood Videos</span>
            <span className="tag bg-gray-700 text-gray-300">AI Tools</span>
            <span className="tag bg-gray-700 text-gray-300">Tutorial</span>
          </div>
          <div className="flex justify-between mt-8 pt-4 border-t border-gray-700 text-sm">
            <Link href="/en/mood" className="text-pink-400 hover:text-pink-300">← Back to Mood Videos</Link>
